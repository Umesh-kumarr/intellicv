...
const SignInPage = () => {
  ...
  const toggleAuthMode = () => {
    const newPath = isLogin ? "/register" : "/signin";
    navigate(newPath);
  };
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg">
        ...
        {!isLogin && (
          <p className="text-xs text-gray-500 text-center mt-6">
            By signing up, you agree to our <a href="/terms" className="text-blue-600 hover:underline">Terms</a> and <a href="/privacy" className="text-blue-600 hover:underline">Privacy Policy</a>
          </p>
        )}
      </div>
    </div>
